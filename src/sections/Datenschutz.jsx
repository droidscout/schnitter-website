  ...
  return (
    <section id="datenschutz" className="datenschutz">
      <div className="container datenschutz__inner">
        ...
        <p>
          RLOX - optimized business eXperience<br />
        ...
        <p>
          Rudolf und Thomas Schnitter GbR<br />
          Bahnweg 51<br />
          85774 Unterf&ouml;hring
        </p>
        <p>
          Telefon: 089 361 095 24<br />
          E-Mail: haustechnik@schnittergbr.de
        </p>
        ...
        <p>WERDEN IHRE PERSONENBEZOGENEN DATEN VERARBEITET, UM DIREKTWERBUNG ZU BETREIBEN, SO HABEN SIE DAS RECHT, JEDERZEIT WIDERSPRUCH GEGEN DIE VERARBEITUNG SIE BETREFFENDER PERSONENBEZOGENEN DATEN ZUM ZWECKE DERARTIGER WERBUNG EINZULEGEN; DIES GILT AUCH F&Uuml;R DAS PROFILING, SOWEIT ES MIT SOLCHER DIREKTWERBUNG IN VERBINDUNG STEHT. WENN SIE WIDERSPRECHEN, WERDEN IHRE PERSONENBEZOGENEN DATEN ANSCHLIESSEND NICHT MEHR ZUM ZWECKE DER DIREKTWERBUNG VERWENDET (WIDERSPRUCH NACH ART. 21 ABS. 2 DSGVO).</p>
